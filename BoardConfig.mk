...
PLATFORM_PATH := device/htc/htc_memwl
...
# Kernel
BOARD_CUSTOM_BOOTIMG_MK := device/htc/htc_memwl/mkbootimg.mk
...
TARGET_KERNEL_CONFIG := lineageos_memwl_defconfig
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/htc/htc_memwl/bluetooth
...
# Includes
TARGET_SPECIFIC_HEADER_PATH := device/htc/htc_memwl/include
...
BOARD_SEPOLICY_DIRS += device/htc/htc_memwl/sepolicy
...
-include vendor/htc/memwl/BoardConfigVendor.mk
